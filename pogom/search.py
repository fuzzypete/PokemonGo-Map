    ...
    for i, account in enumerate(args.accounts):
        ...
        t = Thread(target=search_worker_thread,
                   ...
                   args=(args, account, search_items_queue, parse_lock,
                         ...
                         db_updates_queue, wh_queue, new_location_queue))
        t.daemon = True
        t.start()
...
def search_worker_thread(args, account, search_items_queue, parse_lock, encryption_lib_path, status, dbq, whq, new_location_queue):
