...
#drop everything 
rare_ids = {2, 3, 5, 6, 8, 9, 31, 34, 38, 45, 51, 53, 57, 59, 62, 65, 68, 71, 76, 78, 80, 83, 88, 89, 94, 103, 105, 110, 112, 113, 114, 115, 122, 130, 131, 132, 137, 138, 139, 141, 142, 143, 144, 145, 146}
notify_ids = rare_ids
#hunting
#notify_ids = notify_ids.union({1, 4, 7, 25, 58, 102, 126, 138, 77, 66, 37})
jacobs_ids = notify_ids.union({1, 4, 7, 25, 58, 102, 126, 77, 66, 37})
#EVEE!!!
